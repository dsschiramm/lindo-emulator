...
export module Option {
    ...
    export class Notification {
        ...
        private _not_leader_skip: boolean;
		...
		get not_leader_skip(): boolean {
			return this._not_leader_skip;
		}

		set not_leader_skip(not_leader_skip: boolean) {
			this.settingsProvider.write('option.vip.auto_group.not_leader_skip', not_leader_skip);
			this._not_leader_skip = not_leader_skip;
		}
        ...
        constructor(private settingsProvider: SettingsProvider) {
            ...
            this.not_leader_skip = this.settingsProvider.read('option.vip.auto_group.not_leader_skip');
        }
    }
